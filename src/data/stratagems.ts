...
export const STRATAGEMS: Stratagem[] = [
  ...
  { name: "GR-8 Recoilless Rifle", sequence: ["D", "L", "R", "R", "L"], category: "Support", iconUrl: recoillessSvg },
  ...
  { name: "LAS-99 Quasar Cannon", sequence: ["D", "D", "U", "L", "R"], category: "Support", iconUrl: quasarSvg },
  { name: "MLS-4X Commando", sequence: ["D", "L", "U", "D", "R"], category: "Support", iconUrl: commandoSvg },
  ...
  { name: "SH-32 Shield Generator Pack", sequence: ["D", "U", "L", "R", "L", "R"], category: "Support", iconUrl: shieldGeneratorPackSvg },
  ...
  { name: "A/ARC-3 Tesla Tower", sequence: ["D", "U", "R", "U", "L", "R"], category: "Defensive", iconUrl: teslaTowerSvg },
  { name: "MD-6 Anti-Personnel Minefield", sequence: ["D", "L", "U", "R"], category: "Defensive", iconUrl: antiPersonnelMinesSvg },
  ...
  { name: "A/MG-43 Machine Gun Sentry", sequence: ["D", "U", "R", "R", "U"], category: "Defensive", iconUrl: machineGunSentrySvg },
  { name: "A/G-16 Gatling Sentry", sequence: ["D", "U", "R", "L"], category: "Defensive", iconUrl: gatlingSentrySvg },
  { name: "A/M-12 Mortar Sentry", sequence: ["D", "U", "R", "R", "D"], category: "Defensive", iconUrl: mortarSentrySvg },
  { name: "A/AC-8 Autocannon Sentry", sequence: ["D", "U", "R", "U", "L", "R"], category: "Defensive", iconUrl: autocannonSentrySvg },
  { name: "A/MLS-4X Rocket Sentry", sequence: ["D", "U", "R", "R", "L"], category: "Defensive", iconUrl: rocketSentrySvg },
  { name: "A/M-23 EMS Mortar Sentry", sequence: ["D", "U", "R", "D", "R"], category: "Defensive", iconUrl: emsMortarSentrySvg },
...
export const RANKS = [
  ...
  { minScore: 250, name: "Space Cadet" },
  { minScore: 750, name: "Sergeant" },
  { minScore: 1500, name: "Master Sergeant" },
  { minScore: 3000, name: "Chief" },
  { minScore: 5000, name: "Space Chief Prime" },
  { minScore: 8000, name: "Death Captain" },
  { minScore: 12000, name: "Marshal" },
  { minScore: 18000, name: "Star Marshal" },
  { minScore: 25000, name: "Admiral" },
  { minScore: 35000, name: "Fleet Admiral" },
  { minScore: 50000, name: "Skull Admiral" },
  { minScore: 75000, name: "Commander" },
  { minScore: 100000, name: "Galactic Commander" },
  { minScore: 150000, name: "Hell Commander" },
  { minScore: 250000, name: "General" },
  { minScore: 400000, name: "Chief General" },
  { minScore: 600000, name: "Space Admiral" },
  { minScore: 1000000, name: "Super Citizen" },
  { minScore: 2000000, name: "Super Private" },
];
