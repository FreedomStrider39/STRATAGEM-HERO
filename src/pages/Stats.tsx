...
import { Trophy, ArrowLeft, BarChart3, AlertCircle, RefreshCw } from "lucide-react";
          ...
          <div className="space-y-2">
            {entries.map((entry, idx) => (
              <motion.div 
                ...
                key={idx} 
                className={`flex items-center justify-between px-4 py-4 border-l-4 ${
                  idx === 0 ? 'bg-yellow-400/10 border-yellow-400' : 'bg-white/5 border-white/10'
                }`}
              >
