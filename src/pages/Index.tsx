      ...
      <div className="w-full h-screen max-w-full bg-[#121616] relative flex flex-col items-center justify-center px-12 crt-screen border-x-[8px] border-[#1a1f1f]">
        ...
        <AnimatePresence mode="wait">
          {gameState === "idle" && (
            ...
            >
              <h1 className="text-8xl font-black tracking-tighter text-white mb-4 italic drop-shadow-[0_0_40px_rgba(255,255,255,0.3)] leading-none">
                STRATAGEM HERO
              </h1>
          ...
          {gameState === "playing" && (
            ...
            >
              <div className="flex flex-col items-center justify-between h-full w-full max-w-[1100px] mx-auto relative">
                  ...
                  <AnimatePresence>
                    {isDisrupted && (
                      ...
                      >
                        ...
                        <span className="text-purple-400 text-lg font-bold tracking-[0.2em] animate-pulse text-center">
                    ...
                    {showDisruptorDestroyed && (
                      ...
                      >
                        ...
                        <span className="text-white text-lg font-bold tracking-[0.2em] text-center">
                          DISRUPTOR DESTROYED
                        </span>
                      </motion.div>
                    )}
                ...
                <div className="w-full px-4 mt-6 max-w-3xl">
                  <div className="relative h-6 bg-black/60 border-[3px] border-white/20 overflow-hidden">
                    <motion.div 
          ...
          {gameState === "break" && (
            <motion.div 
              ...
              exit={{ opacity: 0 }}
              className="flex flex-col items-center text-center z-30 bg-black/60 p-20 border-y-[8px] border-yellow-400 w-full"
            >
              <h2 className="text-7xl font-black text-yellow-400 mb-4 italic tracking-tighter text-glow-yellow leading-none">
                ROUND COMPLETE
              </h2>
              <div className="h-1.5 w-[20rem] bg-white/20 mb-8" />
              <p className="text-4xl font-bold text-white mb-6 tracking-widest">PREPARING NEXT WAVE</p>
          ...
          {gameState === "gameover" && (
            ...
            >
              <h2 className="text-7xl font-black text-red-500 mb-12 italic tracking-tighter drop-shadow-[0_0_40px_rgba(239,68,68,0.5)] leading-none">
                MISSION FAILED
              </h2>

              <div className="grid grid-cols-2 gap-x-32 gap-y-8 w-full max-w-[1100px] bg-black/40 p-12 border-[4px] border-white/10">
                <div className="text-left">
                  <p className="text-[#4ade80] text-3xl font-bold tracking-widest">ROUND BONUS</p>
                </div>
                <div className="text-right">
                  <p className="text-yellow-400 text-5xl font-black">{stats.roundBonus}</p>
                </div>

                <div className="text-left">
                  <p className="text-[#4ade80] text-3xl font-bold tracking-widest">TIME BONUS</p>
                </div>
                <div className="text-right">
                  <p className="text-yellow-400 text-5xl font-black">{stats.timeBonus}</p>
                </div>

                <div className="text-left">
                  <p className="text-[#4ade80] text-3xl font-bold tracking-widest">PERFECT BONUS</p>
                </div>
                <div className="text-right">
                  <p className="text-yellow-400 text-5xl font-black">{stats.perfectBonus}</p>
                </div>

                <div className="col-span-2 h-[3px] bg-white/20 my-6" />

                <div className="text-left">
                  <p className="text-[#4ade80] text-4xl font-black tracking-[0.2em]">TOTAL SCORE</p>
                </div>
                <div className="text-right">
                  <p className="text-yellow-400 text-7xl font-black text-glow-yellow leading-none">{stats.totalScore}</p>
                </div>

                <div className="col-span-2 flex justify-center mt-6 pt-6 border-t-2 border-white/10">
                  <p className="text-white/40 text-2xl tracking-[0.3em]">
                    HIGH SCORE: <span className="text-yellow-400/60">{highScore}</span>
                  </p>
                </div>
              </div>

              <p className="mt-16 text-white/40 text-2xl font-bold animate-pulse tracking-[0.5em]">
                PRESS ANY KEY TO REDEPLOY
              </p>
            </motion.div>
          )}
        </AnimatePresence>
