  ...
  return (
    <div className="fixed inset-0 bg-[#0a0c0c] text-white font-sans flex items-center justify-center p-0 overflow-hidden">
      <div className="w-full h-full max-w-full bg-[#121616] relative flex flex-col items-center justify-center px-4 md:px-12 crt-screen border-x-[2px] md:border-x-[8px] border-[#1a1f1f] overflow-y-auto">
        ...
        >
          <div className="relative mb-4 md:mb-6 group">
            ...
            <img 
              ...
              className="w-32 h-32 md:w-48 md:h-48 object-contain relative z-10 drop-shadow-[0_0_20px_rgba(250,204,21,0.3)]"
            />
          </div>

          <h1 className="text-3xl md:text-5xl font-black tracking-tighter text-white mb-2 italic leading-none uppercase">
            <span className="text-yellow-400">Stratagem Hero 2</span>
          </h1>

          <div className="h-1 w-16 md:w-32 bg-yellow-400 mb-4 md:mb-6 shadow-[0_0_15px_rgba(250,204,21,0.6)]" />
          ...
          <div className="flex flex-col items-center gap-4 w-full pt-4 border-t border-white/10">
            <div className="flex gap-6">
              ...
              <Link to="/terms" className="flex items-center gap-1.5 text-[10px] text-yellow-400 hover:text-yellow-300 font-black tracking-widest uppercase transition-colors">
        ...
        <div className="absolute bottom-2 md:bottom-4 left-0 right-0 flex justify-center z-[60] opacity-20 scale-[0.3] md:scale-50">
          <MadeWithDyad />
        </div>
      </div>
    </div>
