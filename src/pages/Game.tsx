...
import { AlertTriangle, CheckCircle2, Trophy, Zap, LogIn, User, Edit2, BarChart3, Shield, Home, LogOut, Settings, Info, FileText, Loader2 } from "lucide-react";
...
const Game = () => {
  ...
  const submitScore = async () => {
    ...
    try {
      // Always upsert if the new score is higher
        ...
        <AnimatePresence mode="wait">
          {gameState === "idle" && (
            ...
            >
              ...
              <div className="mt-8">
                <Link to="/" className="text-[10px] text-white/20 hover:text-white/40 transition-colors font-bold tracking-widest uppercase">
                  Return to Welcome
                </Link>
              </div>
            </motion.div>
